...
# there are 236 taxa (236), so the number of internal nodes
# is `n_taxa-=236-1=235`.
...
# X will be an integer (i.e., 237). Subtract two to this number 
# (i.e., 237-2=235) and this will be your number of divergence times that are 
...
names( dup_dat ) <- c( "LUCA", "TG-EUKARYA-ARCH", "LECA", "FUNGI", "METAZOA",
                       ...
                       "TG-EUKARYA-MITO" )
dup_dat[[1]] <- paste( "t_n", c(238,351), sep = "" )
dup_dat[[2]] <- paste( "t_n", c(258,438), sep = "" )
dup_dat[[3]] <- paste( "t_n", c(259,439), sep = "" )
dup_dat[[4]] <- paste( "t_n", c(262,319,377,442), sep = "" )
dup_dat[[5]] <- paste( "t_n", c(264,320,379,444), sep = "" )
dup_dat[[6]] <- paste( "t_n", c(265,321,380,445), sep = "" )
dup_dat[[7]] <- paste( "t_n", c(270,301,325,384,408,450), sep = "" )
dup_dat[[8]] <- paste( "t_n", c(273,303,386,412,453), sep = "" )
dup_dat[[9]] <- paste( "t_n", c(274,387,454), sep = "" )
dup_dat[[10]] <- paste( "t_n", c(282,395,461), sep = "" )
dup_dat[[11]] <- paste( "t_n", c(297,404), sep = "" )
dup_dat[[12]] <- paste( "t_n", c(298,405), sep = "" )
dup_dat[[13]] <-  paste( "t_n", c(316,373), sep = "" )
