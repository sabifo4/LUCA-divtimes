...
dataset       <- c( "LUCAdup_noef_GBM", "LUCAdup_noef_ILN" )
perc          <- perc
def_samples   <- def_samples
prior         <- FALSE
out_dat       <- all_paths
time_unit     <- 1000
out_file_pdf  <- c( "Convergence_plot_noef_post_GBM",
                   "Convergence_plot_noef_post_ILN" )
...
## [GBM] ####
sum_post_QC$LUCAdup_noef_GBM$ESS_results
# $median
# [1] 20001
# 
# $min
...
# $total_samples
# [1] 309662    235
length( sum_post_QC$LUCAdup_noef_GBM$not_conv_nodes ) # 0
sum_post_QC$LUCAdup_noef_GBM$num_chains # 16

## [[ ILN ]] ####
sum_post_QC$LUCAdup_noef_ILN$ESS_results
# $median
# [1] 20001
# 
# $min
...
# $total_samples
# [1] 311388    235
length( sum_post_QC$LUCAdup_noef_ILN$not_conv_nodes ) # 0
sum_post_QC$LUCAdup_noef_ILN$num_chains # 16
