...
dataset       <- c( "LUCAdup_noleu_GBM", "LUCAdup_noleu_ILN" )
perc          <- perc
def_samples   <- def_samples
prior         <- FALSE
out_dat       <- all_paths
time_unit     <- 1000
out_file_pdf  <- c( "Convergence_plot_post_noleu_GBM",
                   "Convergence_plot_post_noleu_ILN" )
...
## [GBM] ####
sum_post_QC$LUCAdup_noleu_GBM$ESS_results
# $median
# [1] 19383.5
# 
# $min
...
# $total_samples
# [1] 309231    242
length( sum_post_QC$LUCAdup_noleu_GBM$not_conv_nodes ) # 0
sum_post_QC$LUCAdup_noleu_GBM$num_chains # 16

## [[ ILN ]] ####
sum_post_QC$LUCAdup_noleu_ILN$ESS_results
# $median
# [1] 20001
# 
# $min
...
# $total_samples
# [1] 316717    242
length( sum_post_QC$LUCAdup_noleu_ILN$not_conv_nodes ) # 0
sum_post_QC$LUCAdup_noleu_ILN$num_chains # 16
