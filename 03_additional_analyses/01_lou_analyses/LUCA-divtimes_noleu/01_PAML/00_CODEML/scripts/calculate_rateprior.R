...
tree_height <- max( phytools::nodeHeights( raw_tt ) ) #4.0572
...
mean_rate <- tree_height / root_age # 0.8976106 subst/site per time unit
...
#
# Time unit 1Ga (1e+09y): 0.8976106 subst/site/1e+09 = 8.98e-10 subst/site/year
...
alpha <- 2
beta  <- alpha/mean_rate # 2.228138 ~ 2.2
