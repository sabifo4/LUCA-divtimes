...
dataset       <- c( "LUCAdup_notyr_GBM", "LUCAdup_notyr_ILN" )
perc          <- perc
def_samples   <- def_samples
prior         <- FALSE
out_dat       <- all_paths
time_unit     <- 1000
out_file_pdf  <- c( "Convergence_plot_notyr_post_GBM",
                   "Convergence_plot_notyr_post_ILN" )
...
## [GBM] ####
sum_post_QC$LUCAdup_notyr_GBM$ESS_results
# $median
# [1] 18818.5
# 
# $min
...
# $total_samples
# [1] 301595    243
length( sum_post_QC$LUCAdup_notyr_GBM$not_conv_nodes ) # 0
sum_post_QC$LUCAdup_notyr_GBM$num_chains # 16

## [[ ILN ]] ####
sum_post_QC$LUCAdup_notyr_ILN$ESS_results
# $median
# [1] 19807
# 
# $min
...
# $total_samples
# [1] 313964    243
length( sum_post_QC$LUCAdup_notyr_ILN$not_conv_nodes ) # 0
sum_post_QC$LUCAdup_notyr_ILN$num_chains # 16
