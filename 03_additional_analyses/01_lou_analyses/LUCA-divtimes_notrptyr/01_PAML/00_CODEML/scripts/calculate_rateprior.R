...
tree_height <- max( phytools::nodeHeights( raw_tt ) ) #3.954152
...
mean_rate <- tree_height / root_age # 0.8748124 subst/site per time unit
...
#
# Time unit 1Ga (1e+09y): 0.8748124 subst/site/1e+09 = 8.75e-10 subst/site/year
