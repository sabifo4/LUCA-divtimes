...
tree_height <- max( phytools::nodeHeights( raw_tt ) ) #4.214833
...
mean_rate <- tree_height / root_age # 0.9324852 subst/site per time unit
...
#
# Time unit 1Ga (1e+09y): 0.9324852 subst/site/1e+09 = 9.325e-10 subst/site/year
