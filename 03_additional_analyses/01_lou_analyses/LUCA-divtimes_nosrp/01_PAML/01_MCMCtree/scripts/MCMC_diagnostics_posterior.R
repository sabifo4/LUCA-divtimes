...
dataset       <- c( "LUCAdup_nosrp_GBM", "LUCAdup_nosrp_ILN" )
perc          <- perc
def_samples   <- def_samples
prior         <- FALSE
out_dat       <- all_paths
time_unit     <- 1000
out_file_pdf  <- c( "Convergence_plot_nosrp_post_GBM",
                   "Convergence_plot_nosrp_post_ILN" )
...
## [GBM] ####
sum_post_QC$LUCAdup_nosrp_GBM$ESS_results
# $median
# [1] 18874.5
# 
# $min
...
# $total_samples
# [1] 299216    245
length( sum_post_QC$LUCAdup_nosrp_GBM$not_conv_nodes ) # 0
sum_post_QC$LUCAdup_nosrp_GBM$num_chains # 16

## [[ ILN ]] ####
sum_post_QC$LUCAdup_nosrp_ILN$ESS_results
# $median
# [1] 19955.5
# 
# $min
...
# $total_samples
# [1] 306831    245
length( sum_post_QC$LUCAdup_nosrp_ILN$not_conv_nodes ) # 0
sum_post_QC$LUCAdup_nosrp_ILN$num_chains # 16
