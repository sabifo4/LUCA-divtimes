...
dataset       <- c( "LUCAdup_noatp_GBM", "LUCAdup_noatp_ILN" )
perc          <- perc
def_samples   <- def_samples
prior         <- FALSE
out_dat       <- all_paths
time_unit     <- 1000
out_file_pdf  <- c( "Convergence_plot_noatp_post_GBM",
                   "Convergence_plot_noatp_post_ILN" )
...
## [GBM] ####
sum_post_QC$LUCAdup_noatp_GBM$ESS_results
# $median
# [1] 20001
# 
# $min
...
# $total_samples
# [1] 317068    240
length( sum_post_QC$LUCAdup_noatp_GBM$not_conv_nodes ) # 0
sum_post_QC$LUCAdup_noatp_GBM$num_chains # 16

## [[ ILN ]] ####
sum_post_QC$LUCAdup_noatp_ILN$ESS_results
# $median
# [1] 20001
# 
# $min
...
# $total_samples
# [1] 319405    240
length( sum_post_QC$LUCAdup_noatp_ILN$not_conv_nodes ) # 0
sum_post_QC$LUCAdup_noatp_ILN$num_chains # 16
