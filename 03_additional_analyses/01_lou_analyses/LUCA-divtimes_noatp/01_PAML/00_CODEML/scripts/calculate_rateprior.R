...
tree_height <- max( phytools::nodeHeights( raw_tt ) ) #4.08388
...
mean_rate <- tree_height / root_age # 0.9035133 subst/site per time unit
...
#
# Time unit 1Ga (1e+09y): 0.9035133 subst/site/1e+09 = 9.04e-10 subst/site/year
