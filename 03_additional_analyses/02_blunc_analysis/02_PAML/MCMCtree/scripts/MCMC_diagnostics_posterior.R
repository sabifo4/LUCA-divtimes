...
dataset       <- c( "LUCAdup_bsinbv_GBM", "LUCAdup_bsinbv_ILN" )
perc          <- perc
def_samples   <- def_samples
prior         <- FALSE
out_dat       <- all_paths
time_unit     <- 1000
out_file_pdf  <- c( "Convergence_plot_bsinbv_post_GBM",
                   "Convergence_plot_bsinbv_post_ILN" )
...
## [GBM] ####
sum_post_QC$LUCAdup_bsinbv_GBM$ESS_results
# $median
# [1] 19138.5
# 
# $min
...
# $total_samples
# [1] 304994    245
length( sum_post_QC$LUCAdup_bsinbv_GBM$not_conv_nodes ) # 0
sum_post_QC$LUCAdup_bsinbv_GBM$num_chains # 16

## [[ ILN ]] ####
sum_post_QC$LUCAdup_bsinbv_ILN$ESS_results
# $median
# [1] 19369.5
# 
# $min
...
# $total_samples
# [1] 294515    245
length( sum_post_QC$LUCAdup_bsinbv_ILN$not_conv_nodes ) # 0
sum_post_QC$LUCAdup_bsinbv_ILN$num_chains # 16
