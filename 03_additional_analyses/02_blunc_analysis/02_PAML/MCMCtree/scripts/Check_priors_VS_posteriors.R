...
# GBM: The number of lines is 304994, and so you need to specify one less
# ILN: The number of lines is 294515, and so you need to specify one less
#
...
def_samples <- c( 120005, 304993, 294514 )
...
# approaches.
num_dirs     <- 3
paths_dat    <- c( "../../../../../01_PAML/02_MCMCtree/sum_analyses/00_prior/mcmc_files_CLK",
