...
# GBM: The number of lines is 38434, and so you need to specify one less
# ILN: The number of lines is 37795, and so you need to specify one less
def_samples <- c( 120005, 38433, 37794 )
...
paths_dat <- c( paste( home_dir,
                       ...
                       sep = "" ),
                paste( home_dir,
                       "sum_analyses/01_posterior/mcmc_files_part_fosscb_GBM",
                       sep = "" ),
                paste( home_dir,
                       "sum_analyses/01_posterior/mcmc_files_part_fosscb_ILN",
                       sep = "" )
)
