...
def_samples <- 120005 # there were 120,0006, so one less
...
delcol_prior   <- 5 # There is one column: mu[1-5]
...
path_prior  <- paste( home_dir,
                      "sum_analyses/00_prior/mcmc_files_part_fosscb_CLK",
                      sep = "" )
