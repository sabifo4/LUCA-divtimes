...
#--------------#
# Load tree 
raw_tt <- ape::read.tree( file = "../../00_data_formatting/00_raw_data/trees/00_IQTREE/round2/LUCAdup_topo_bl_rooted.tree" )
...
tree_height <- max( phytools::nodeHeights( raw_tt ) ) #3.665453
...
mean_rate <- tree_height / root_age # 0.8109409 subst/site per time unit
...
#
# Time unit 1Ga (1e+09y): 0.8109409 subst/site/1e+09 = 8.11e-10 subst/site/year
...
alpha <- 2
beta  <- alpha/mean_rate # 2.466271 ~ 2.5
