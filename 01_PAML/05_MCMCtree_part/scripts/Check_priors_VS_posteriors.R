...
# GBM: The number of lines is 56203, and so you need to specify one less
# ILN: The number of lines is 56889, and so you need to specify one less
def_samples <- c( 120005, 56202, 56888 )
...
# approaches.
num_dirs     <- 3
paths_dat    <- c( paste( home_dir, "sum_analyses/00_prior/mcmc_files_part_CLK",
                          sep = "" ),
                   paste( home_dir,
                          "sum_analyses/01_posterior/mcmc_files_part_GBM",
                          sep = "" ),
                   paste( home_dir,
                          "sum_analyses/01_posterior/mcmc_files_part_ILN",
                          sep = "" )
)
