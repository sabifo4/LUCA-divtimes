...
#--------------#
# Load tree 
raw_tt <- ape::read.tree( file = "../../00_data_formatting/00_raw_data/trees/01_round2/LUCAdup_bl.tree" )
...
tree_height <- max( phytools::nodeHeights( raw_tt ) ) #3.457051
...
mean_rate <- tree_height / root_age # 0.7648344 subst/site per time unit
...
#
# Time unit 1Ga (1e+09y): 0.7648344 subst/site/1e+09 = 7.64e-10 subst/site/year
