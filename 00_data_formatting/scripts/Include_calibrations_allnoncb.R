...
out_name <- c( "LUCAdup_246sp_allnoncb" )
...
path_tree <- c( "../00_raw_data/trees/01_calibrations/LUCAdup_allnoncb_calibnames.tree" )
...
# file provided.
path_textconv <- c( "Calib_converter_allnoncb.txt" )
